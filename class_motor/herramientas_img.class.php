...
{
	public static function url_escalar($ruta, $ancho, $alto)
	{
		return Constantes::URL_WEB.'inc_motor/imagenes.inc.php?modo=reescalar&src='.$ruta.'&w='.$ancho.'&h='.$alto;
	}

	public static function url_proporcion($ruta, $ancho, $alto)
	{
		return Constantes::URL_WEB.'inc_motor/imagenes.inc.php?modo=reescalar_minimo&src='.$ruta.'&w='.$ancho.'&h='.$alto;
	}

	public static function url_recortar($ruta, $ancho, $alto)
	{
		return Constantes::URL_WEB.'inc_motor/imagenes.inc.php?modo=reescalar_recortar&src='.$ruta.'&w='.$ancho.'&h='.$alto;
	}

	public static function generar_url($tipo, $fuente, $ancho, $alto)
	{	
		return Constantes::URL_WEB.'inc_motor/imagenes.inc.php?modo='.$tipo.'&src='.$fuente.'&w='.$ancho.'&h='.$alto;
	}
...
*/	
	...
	public static function marcar_agua($ruta)
	{
		...
		{
			$resultado=self::marcar_agua_desde_recurso($imagen, Constantes::RUTA_SERVER.'img/marca_agua.png');
